...
export default function IdnttYesweareMain() {
    DoruriDocumentTitle('yesweare');

    return (
        <div className='idn_Yesweare_m_full'>
            <Menu />
            <section className="home_translate">
                <Link to='/IdnttYesweareMain' className="on">한국어</Link>
                <Link to='/IdnttYesweareMainEng'>English</Link>
            </section>
            <img src='' alt="yesweare 로고" className='tri_m_logo' />
            <h2 className='tri_m_h2 tri_m_h2_1'><img src={MainH2Deco} alt="yesweare 꾸미기" />yesweare<img src={MainH2Deco} alt="yesweare 꾸미기" /></h2>
            <p className='tri_m_intropp'>
                &apos;yesweare&apos;과 함께<br />
                본질의 감각을<br />
                생각해 봐요!
            </p>
            <img src='' className='tri_m_img' alt='yesweare 이미지' />
            <h2 className='tri_m_h2 tri_m_h2_2'>▪ 멤버 ▪</h2>
            <section className='tri_m_mem_tr_full idn_Yesweare_m_mem_tr_full'>
