...
import '../../BTOB/albums/BtobWeAgainAlbum.css';

import MenuEng from '../../HomeEng/MenuEng';
import FooterPartEng from '../../FooterPartEng';

import BtobWeAgainAlbum_img from '../../BTOB/albums/img/BtobWeAgainAlbum_img.jpg';

import MainH2deco from '../../img/main_h2_deco.png';

export default function BtobWeAgainAlbumEng() {
    EngPage('en', 'ko');
    ...
    return (
        <div className='btob_BtobWeAgainAlbum_full'>
            ...
            <section className="home_translate">
                <Link to='/BtobWeAgainAlbum'>한국어</Link>
                <Link to='/BtobWeAgainAlbumEng' className="on">English</Link>
            </section>
            <h2 className='tri_BabyFlowerCityRemixesAlbum_h2 tri_BabyFlowerCityRemixesAlbum_h2_1'>
                <img src={MainH2deco} alt="btob" />We again<img src={MainH2deco} alt="btob" />
            </h2>
            <p className='tri_BabyFlowerCityRemixesAlbum_intropp'>
                This is an album prepared<br />
                with all my heartfelt<br />
                sincerity in it!
            </p>
