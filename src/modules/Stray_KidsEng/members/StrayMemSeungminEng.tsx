...
export default function StrayMemSeungminEng() {
    return (
        <div className="str_mm_seungmin_full">
            ...
            <h2 className='tri_mm_s1_h2 tri_mm_s1_h2_1'><img src={MainH2Deco} alt="Stray Kids deco" />승민<img src={MainH2Deco} alt="Stray Kids deco" /></h2>
            <p className='tri_mm_s1_intropp'>24명은 너무 많지 않아요?<br />
                그리고... 그리고... 그리고...<br />
                더 열심히 더 열심히</p>
            <img src='' alt="승민 이미지" className='tri_mm_s1_img' />
