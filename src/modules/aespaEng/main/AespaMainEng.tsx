...
import Aes_m_img from '../../aespa/main/img/aespa_m_aespa.jpg';

import Aes_m_MemKarina_img from '../../aespa/main/img/aespa_m_mem_Karina.jpg';
import Aes_m_MemJijell_img from '../../aespa/main/img/aespa_m_mem_Jijel.jpg';
import Aes_m_MemWinter_img from '../../aespa/main/img/aespa_m_mem_Winter.jpg';
import Aes_m_MemNingning_img from '../../aespa/main/img/aespa_m_mem_Ningning.jpg';
    ...
    return (
        <div className='aes_m_full'>
            ...
            <section className="home_translate">
                <Link to='/AespaMain'>한국어</Link>
                <Link to='/AespaMainEng' className="on">English</Link>
            </section>
            ...
            <section className='tri_m_mem_tr_full aes_m_mem_tr_full'>
                <section className='tri_m_mem_tr'>
                    <Link to='/AesMemKarinaEng' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Aes_m_MemKarina_img} alt="Karina" />
                            <div>
                                <h4>Karina</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/AesMemJijellEng' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Aes_m_MemJijell_img} alt="Giselle" />
                            <div>
                                <h4>Giselle</h4>
                            </div>
                        </article>
                ...
                <section className='tri_m_mem_tr'>
                    <Link to='/AesMemWinterEng' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Aes_m_MemWinter_img} alt="Winter" />
                            <div>
                                <h4>Winter</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/AesMemNingningEng' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Aes_m_MemNingning_img} alt="Ningning" />
                            <div>
                                <h4>Ningning</h4>
                            </div>
                        </article>
