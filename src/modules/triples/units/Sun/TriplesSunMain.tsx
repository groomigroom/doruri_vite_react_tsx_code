...
export default function TriplesSunMain() {
    ...
    return (
        <div className='tri_sun_m_full'>
            ...
            <h2 className='tri_m_h2 tri_sun_m_h2_5'>▪ 최신 앨범 ▪</h2>
            <section className='tri_m_album_tr_full tri_sun_m_album_tr_full'>
                <section className='tri_m_album_tr'>
                    <Link to='/TriplesBabyFlowerCityRemixesAlbum' className='tri_m_album_a tri_sun_m_album_a'>
