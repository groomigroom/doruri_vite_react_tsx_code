    ...
    return (
        <div className='idn_Itsnotover_m_full'>
            ...
            <section className="home_translate">
                <Link to='/IdnttItsnotoverMain' className="on">한국어</Link>
                <Link to='/IdnttItsnotoverMainEng'>English</Link>
            </section>
            <img src='' alt="itsnotover 로고" className='tri_m_logo' />
            <h2 className='tri_m_h2 tri_m_h2_1'><img src={MainH2Deco} alt="itsnotover 꾸미기" />itsnotover<img src={MainH2Deco} alt="itsnotover 꾸미기" /></h2>
            <p className='tri_m_intropp'>
                &apos;itsnotover&apos;와 함께<br />
                힘을 내고<br />
                거침없이 나아가 봐요!
            </p>
            <img src='' className='tri_m_img' alt='itsnotover 이미지' />
            <h2 className='tri_m_h2 tri_m_h2_2'>▪ 멤버 ▪</h2>
            <section className='tri_m_mem_tr_full idn_Itsnotover_m_mem_tr_full'>

                <section className='idn_Itsnotover_m_mem_tr3'>
                ...
                <section className='idn_Itsnotover_m_mem_tr2'>
