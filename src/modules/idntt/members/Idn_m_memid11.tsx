...
import Idn_mm_memid11_img from '../main/img/Idn_mm_id11_img.jpg';

import MainH2Deco from '../../img/main_h2_deco.png';

export default function Idn_m_memid11() {
    DoruriDocumentTitle('이규혁');
    ...
    return (
        <div className="idn_mm_id11_full">
            ...
            <img src={Idn_mm_memid11_img} alt="이규혁 이미지" className='tri_mm_s1_img idn_mm_id11_img' />
            <table className='tri_mm_s1_intropa_tb idn_mm_id11_intropa_tb'>
                <tbody>
