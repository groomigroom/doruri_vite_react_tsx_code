...
import Idn_mm_memid4_img from '../main/img/Idn_mm_id4_img.jpg';

import MainH2Deco from '../../img/main_h2_deco.png';

export default function Idn_m_memid4() {
    DoruriDocumentTitle('최태인');
    ...
    return (
        <div className="idn_mm_id4_full">
            ...
            <img src={Idn_mm_memid4_img} alt="최태인 이미지" className='tri_mm_s1_img idn_mm_id4_img' />
            <table className='tri_mm_s1_intropa_tb idn_mm_id4_intropa_tb'>
                <tbody>
