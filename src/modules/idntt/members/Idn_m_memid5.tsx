...
import Idn_mm_memid5_img from '../main/img/Idn_mm_id5_img.jpg';

import MainH2Deco from '../../img/main_h2_deco.png';

export default function Idn_m_memid5() {
    DoruriDocumentTitle('이재영');
    ...
    return (
        <div className="idn_mm_id5_full">
            ...
            <img src={Idn_mm_memid5_img} alt="이재영 이미지" className='tri_mm_s1_img idn_mm_id5_img' />
            <table className='tri_mm_s1_intropa_tb idn_mm_id5_intropa_tb'>
                <tbody>
