...
import '../../../ARTMS/units/OddEyeCircle/ArtmsOddEyeCircleMain.css';
...
export default function ArtmsOddEyeCircleMainEng() {
    EngPage('en', 'ko');
    ...
    return (
        <div className='art_OddEyeCircle_m_full'>
            ...
            <section className="home_translate">
                <Link to='/ArtmsOddEyeCircleMain'>한국어</Link>
                <Link to='/ArtmsOddEyeCircleMainEng' className="on">English</Link>
            </section>
            <img src='' alt="ODD EYE CIRCLE logo" className='tri_m_logo' />
            <h2 className='tri_m_h2 tri_m_h2_1'><img src={MainH2Deco} alt="ODD EYE CIRCLE deco" />ODD EYE CIRCLE<img src={MainH2Deco} alt="ODD EYE CIRCLE deco" /></h2>
            <p className='tri_m_intropp'>
                How about having some<br />
                sweet thoughts<br />
                together with &apos;ODD EYE CIRCLE&apos;?
            </p>
