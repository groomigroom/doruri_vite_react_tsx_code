    ...
    return (
        <div className="tws_mm_gyungmin_full">
            ...
            <section className="home_translate">
                <Link to='/TwsMemGyungmin'>한국어</Link>
                <Link to='/TwsMemGyungminEng' className="on">English</Link>
            </section>
            <h2 className='tri_mm_s1_h2 tri_mm_s1_h2_1'><img src={MainH2Deco} alt="TWS deco" />Kyungmin<img src={MainH2Deco} alt="TWS deco" /></h2>
