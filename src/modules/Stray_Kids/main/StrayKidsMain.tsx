    ...
    return (
        <div className='str_m_full'>
            ...
            <section className='tri_m_logo_section'>
                <img src={Str_m_logo} alt="스트레이 키즈 로고" />
            </section>
            ...
            <section className='tri_m_img'>
                <img src={Str_m_img} alt='스트레이 키즈' className='tri_m_mem_imgborder' />
            </section>
            <section className='tri_m_h2'>
                <h2>▪ 멤버 ▪</h2>
            </section>
            ...
            <section className='tri_m_mem_tr_full'>
                ...
                <section className='tri_m_mem_tr4'>
                    <Link to='/StrayMemBangchan' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemBangchan_img} alt="방찬 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>방찬</h4>
                            </div>
                        </article>
                    </Link>
                    <Link to='/StrayMemLino' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemLino_img} alt="리노 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>리노</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/StrayMemChangbin' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemChangbin_img} alt="창빈 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>창빈</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/StrayMemHyunjin' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemHyunjin_img} alt="현진 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>현진</h4>
                            </div>
                        </article>
                ...
                <section className='tri_m_mem_tr4'>
                    <Link to='/StrayMemHan' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemHan_img} alt="한 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>한</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/StrayMemFilix' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemFilix_img} alt="필릭스 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder'>
                                <h4>필릭스</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/StrayMemSeungmin' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemSeungmin_img} alt="승민 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>승민</h4>
                            </div>
                        </article>
                    ...
                    <Link to='/StrayMemIn' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_MemIn_img} alt="아이엔 이미지" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>아이엔</h4>
                            </div>
                        </article>
            ...
            <section className='tri_m_mem_tr_full'>
                <section className='tri_m_mem_tr1'>
                    <Link to='/StrayKidsThreeRachaMain' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={StrayKids3Racha_m_img} alt="3RACHA" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>3RACHA</h4>
                            </div>
                        </article>
            ...
            <section className='tri_m_mem_tr_full'>
                <section className='tri_m_mem_tr1'>
                    <Link to='/StrayKidsEvent' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={Str_m_img} alt="stray kids event" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>Replay<br />
                                    이벤트</h4>
                            </div>
            ...
            <section className='tri_m_mem_tr_full'>
                <section className='tri_m_mem_tr1'>
                    <Link to='/StrayKidsSKZReplay2026Pt1Album' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={StrayKidsSKZReplay2026Pt1Album_img} alt="StrayKidsSKZReplay2026Pt1Album" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>
                                    SKZ<br />
                                    Replay<br />
            ...
            <section className='tri_m_mem_tr_full'>
                <section className='tri_m_mem_tr2'>
                    <a href="https://www.instagram.com/realstraykids" target='_blank' rel='noopener noreferrer' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={StrayKidsInstagram_img} alt="Stray Kids 인스타그램" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>
                                    인스타그램
                                </h4>
                    ...
                    <a href="https://www.youtube.com/@StrayKids" target='_blank' rel='noopener noreferrer' className='tri_m_mem_a'>
                        <article className='tri_m_mem'>
                            <img src={StrayKidsYoutube_img} alt="Stray Kids 유튜브" className='tri_m_mem_imgborder' />
                            <div className='tri_m_mem_imgborder' >
                                <h4>
                                    유튜브
                                </h4>
